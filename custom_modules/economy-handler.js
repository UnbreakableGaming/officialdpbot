 ...
 */
  ...
  fetch: function(key, ops) {
    if (!key) throw new TypeError('No key specified. Need help? Please contact a staff member for assistance!');
 ...
 */
  ...
  set: function(key, value, ops) {
    if (!key) throw new TypeError('No key specified. Need help? Please contact a staff member for assistance!');
    if (!value && value != 0) throw new TypeError('No value specified. Need help? Please contact a staff member for assistance!');
 ...
 */
  ...
  add: function(key, value, ops) {
    if (!key) throw new TypeError('No key specified. Need help? Please contact a staff member for assistance!');
    if (isNaN(value)) throw new TypeError('Must specify value to add. Need help? Please contact a staff member for assistance!');
 ...
 */
  ...
  push: function(key, value, ops) {
    if (!key) throw new TypeError('No key specified. Need help? Please contact a staff member for assistance!');
    if (!value && value != 0) throw new TypeError('Must specify value to push. Need help? Please contact a staff member for assistance!');
 ...
 */
  ...
  table: function(tableName, options = {}) {
    ...
    // Set Name
    if (typeof tableName !== 'string') throw new TypeError('Table name has to be a string. Need help? Please contact a staff member for assistance!');
    else if (tableName.includes(' ')) throw new TypeError('Table name cannot include spaces. Need help? Please contact a staff member for assistance!');
