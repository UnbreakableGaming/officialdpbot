...
exports.run = async (client, message, args) => {
    ...
    let ownerOnly = new Discord.RichEmbed()
        .setAuthor("DarkPurple Setup","https://cdn.discordapp.com/attachments/701803083629592577/733311080851439636/2Q.png")
        .setColor(`#FF0062`)
        .setTitle(`🚫 Only The Owner Of The Server Can Run This Command! 🚫`)
        .setFooter(`© DarkPurple | Owned by Unbreakable | Developed by Unbreakable Only\n${message.guild.name} Utilities ➤ Command ran by ${message.author.username}`,"https://cdn.discordapp.com/attachments/632238663094370366/632916675808854026/profile.png")
    ...
    let setUp = new Discord.RichEmbed()
        .setAuthor("DarkPurple Setup","https://cdn.discordapp.com/attachments/701803083629592577/733311080851439636/2Q.png")
        .setColor(`#FF0062`)
        .setTitle(`Thanks For Using DarkPurple`)
        .setDescription(`Make sure to checkout the [coming soon] to see what I create/remove!`)
        .setFooter(`© DarkPurple | Owned Unbreakable  | Developed by Unbreakable\n${message.guild.name} Utilities ➤ Command ran by ${message.author.username}`,"https://cdn.discordapp.com/attachments/632238663094370366/632916675808854026/profile.png")
